...
{
    public class DeleteQuizRequestHandler : IRequestHandler<DeleteQuizQuery, Response<Guid?>>
    {
        ...
        public async Task<Response<Guid?>> Handle(DeleteQuizQuery request, CancellationToken cancellationToken)
        {
